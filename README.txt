...
Each turn, the designated player tries to type the same vowels as in the string, and add an extra 2 vowels of their choice.
If they get the initial string correct, it transitions to the next player, who repeats the string (including the previously added vowels), and adds another 2.
